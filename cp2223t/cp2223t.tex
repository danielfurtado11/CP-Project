...
\begin{eqnarray*}
\begin{cases}
g . in = l . F \ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}}\\
h . in = j . F \ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}}\\
f . in = k . F \ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}}\\
\end{cases} 
\end{eqnarray*}

% 
  \equiv{ \ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}} = \ensuremath{\llparenthesis\, \conj{\conj{\Varid{l}}{\Varid{j}}}{\Varid{k}}\,\rrparenthesis}} 
%


Com o auxílio de duas funções novas \ensuremath{\Varid{g}} e \ensuremath{\Varid{h}} é possível aplicar a recursividade múltipla neste problema.

Sabendo que:

\begin{eqnarray*}
\begin{cases}
\ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{3})} = \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})}\\
\ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2})} = \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}\\
\ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2})} = \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})}\\
\ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
\end{cases}
\end{eqnarray*}
...
\begin{cases}
      \begin{cases}
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}} = 1\\
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = a * \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}} + b * \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}} + c * \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}} = 1\\  
        \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}} = 1\\
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}
\end{cases}
\end{eqnarray*}
...
\begin{cases}
      \begin{cases}
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}} = a\\
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = l2 ((\ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}, \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}), \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}})
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}} = b\\  
        \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = j2 ((\ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}, \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}), \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}})
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}} = c\\
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = k2 ((\ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}, \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}), \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}})
      \end{cases}
\end{cases}
\end{eqnarray*}
...
\ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}} = \ensuremath{\llparenthesis\, \conj{\conj{[\mskip1.5mu \underline{\Varid{a}},l_2 \mskip1.5mu]}{[\mskip1.5mu \underline{\Varid{b}},\Varid{j2}\mskip1.5mu]}}{[\mskip1.5mu \underline{\Varid{c}},\Varid{k2}\mskip1.5mu]}\,\rrparenthesis}

%
\just\equiv{ lei da troca (2 vezes)}
%

\ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}} = \ensuremath{\llparenthesis\, \alt{\conj{\conj{\underline{\Varid{a}}}{\underline{\Varid{b}}}}{\underline{\Varid{c}}}}{\conj{\conj{l_2 }{\Varid{j2}}}{\Varid{k2}}}\,\rrparenthesis}

%
\just\equiv{ propriedade dada nas aulas, ficha 3}
%

\ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}} = \ensuremath{\llparenthesis\, \alt{((\Varid{a},\Varid{b}),\Varid{c})}{\conj{\conj{l_2 }{\Varid{j2}}}{\Varid{k2}}}\,\rrparenthesis}
...
\ensuremath{\conj{\conj{\Varid{g}}{\Varid{h}}}{\Varid{f}}} = for \ensuremath{\conj{\conj{l_2 }{\Varid{j2}}}{\Varid{k2}}} ((a,b),c)


Substituindo ((a,b),c) por ((1,1),0) visto que é o caso inicial. 
Substituindo l2 pela função auxliar \ensuremath{\Varid{func}} que multiplica os parâmetros respetivos por a, b e c e soma-os, j2 por p1 . p1 e k2 por p2.p1 então será possível chegar ao resultado.  
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{func}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}\Varid{a}\mathbin{*}\Varid{x}\mathbin{+}\Varid{b}\mathbin{*}\Varid{y}\mathbin{+}\Varid{c}\mathbin{*}\Varid{z}{}\<[E]%
\\
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[13]%
\>[13]{}\mathrel{=}\conj{\conj{\Varid{func}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\p1\comp \p1}}{\p2\comp \p1}{}\<[E]%
\\
...
\begin{figure}[h!]
  ...
  \caption{Teste de performance para a função já predefinida \ensuremath{\Varid{f}}.}
  \label{fig:sierp2}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{Teste de performance para a função \ensuremath{\Varid{fbl}} baseada em recursividade múltipla.}
  \label{fig:sierp2}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{Teste de verificação de resultados entre a função \ensuremath{\Varid{f}} e \ensuremath{\Varid{fbl}}.}
  \label{fig:sierp2}
\end{figure}
...
\xymatrix{
  \ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}} & & S + S \times (\ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}})^*\ar[ll]_{\ensuremath{\mathsf{in}_{\tiny\ \textit{Exp}}}} \\
  S^*\ar@/_1.5pc/[rr]_{\ensuremath{\Varid{gene}}}\ar[r]^(0.35){\ensuremath{\Varid{out}}}\ar[u]^{\ensuremath{\Varid{tax}}} & S + S \times S^*\ar[r]^(0.45){\ensuremath{\Varid{funcA}}} & S + S \times (S^*)^*\ar[u]_{id + id \times tax^*}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{auxiliar}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxiliar}\mathrel{=}\Varid{groupBy}\;(\lambda \Varid{x}\;\Varid{y}\to (\Varid{head}\;\Varid{y})\equiv \text{\ttfamily '~'}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{funcA}\mathrel{=}(\Varid{id}+\Varid{id}\times(\Varid{auxiliar}\comp \map \;(\Varid{drop}\;\mathrm{4}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gene}\mathrel{=}\Varid{funcA}\comp \Varid{out}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{post}\;(\Conid{Term}\;\Varid{x}\;\Varid{ts})\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{x}\mskip1.5mu]\mskip1.5mu]\mathbin{+\!\!\!+}\Varid{concatMap}\;(\lambda \Varid{t}\to \map \;(\Varid{x}\mathbin{:})\;(\Varid{post}\;\Varid{t}))\;\Varid{ts}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Square}\mathbin{+}\Conid{Rose}\;\Conid{Square}}^*
           \ar[l]_-{\ensuremath{\Varid{inRose}}}
\\
     \ensuremath{\Conid{Square}\times\N_0}
           \ar[r]_-{\ensuremath{\Varid{gsp}}}
           \ar[u]^-{\ensuremath{\ana{\Varid{gsp}}}}
&
     \ensuremath{\Conid{Square}\times(\Conid{Square}\times\N_0)}^*
           \ar[u]_{\ensuremath{\Varid{id}\times\map \;\ana{\Varid{gsp}}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Rose}\;\Conid{Square}}
           ...
           \ar[r]^-{\ensuremath{\Varid{outRose}}}
&
    \ensuremath{\Conid{Square}\times\Conid{Rose}\;\Conid{Square}}^*
           \ar[d]^{\ensuremath{\Varid{id}\times\map \;\llparenthesis\, \Varid{gr2l}\,\rrparenthesis}}
\\
     \ensuremath{\Conid{Square}}^*
&
     \ensuremath{\Conid{Square}\times(\Conid{Square}}^*)^*
...
\xymatrix{
    \ensuremath{\Conid{Square}\times\N_0}
           \ar[r]_-{\ensuremath{\Varid{gsp}}}
           \ar[d]_-{\ensuremath{\ana{\Varid{gsp}}}}
&   
    \ensuremath{\Conid{Square}\times(\Conid{Square}\times\N_0})^*
           \ar[d]^{\ensuremath{\Varid{id}\times\map \;\ana{\Varid{gsp}}}}
\\
    \ensuremath{\Conid{Rose}\;\Conid{Square}}
           \ar[d]_-{\ensuremath{\llparenthesis\, \Varid{gr2l}\,\rrparenthesis}}
           \ar@/^1.5pc/[r]^{\ensuremath{\Varid{outRose}}}
&
    \ensuremath{\Conid{Square}\times\Conid{Rose}\;\Conid{Square}}^*
           \ar[d]^{\ensuremath{\Varid{id}\times\map \;\llparenthesis\, \Varid{gr2l}\,\rrparenthesis}}
           \ar@/^1.5pc/[l]^{\ensuremath{\Varid{inRose}}}
\\
     \ensuremath{\Conid{Square}}^*
&
     \ensuremath{\Conid{Square}\times(\Conid{Square}}^*)^*
...
\\
\>[B]{}\Varid{gsq}\;(\Varid{x},\Varid{xs})\mathrel{=}(\Varid{auxaux}\;\Varid{x},\Varid{auxsquare}\;(\Varid{x},\Varid{xs})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxaux}\mathbin{::}\Conid{Square}\to \Conid{Square}{}\<[E]%
\\
\>[B]{}\Varid{auxaux}\;((\Varid{x},\Varid{y}),\Varid{s})\mathrel{=}((\Varid{x}\mathbin{+}\mathrm{1}\mathbin{/}\mathrm{3}\mathbin{*}\Varid{s},\Varid{y}\mathbin{+}\mathrm{1}\mathbin{/}\mathrm{3}\mathbin{*}\Varid{s}),\Varid{s}\mathbin{/}\mathrm{3}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxsquare}\mathbin{::}(\Conid{Square},\Conid{Int})\to [\mskip1.5mu (\Conid{Square},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxsquare}\;(((\Varid{x},\Varid{y}),\Varid{side}),\Varid{d})\mathrel{=}\Varid{auxsquare'}\;(((\Varid{x},\Varid{y}),\Varid{side}),\Varid{d})\;(\Varid{side}\mathbin{/}\mathrm{3}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxsquare'}\mathbin{::}(\Conid{Square},\Conid{Int})\to \Conid{Side}\to [\mskip1.5mu (\Conid{Square},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxsquare'}\;(((\Varid{x},\Varid{y}),\Varid{side}),\mathrm{0})\;\Varid{nl}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxsquare'}\;(((\Varid{x},\Varid{y}),\Varid{side}),\Varid{d})\;\Varid{nl}\mathrel{=}[\mskip1.5mu (((\Varid{x}\mathbin{+}\Varid{i}\mathbin{*}\Varid{nl},\Varid{y}\mathbin{+}\Varid{j}\mathbin{*}\Varid{nl}),\Varid{nl}),\Varid{d}\mathbin{-}\mathrm{1})\mid \Varid{i}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{2}\mskip1.5mu],\Varid{j}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{2}\mskip1.5mu],(\Varid{i},\Varid{j})\not\equiv (\mathrm{1},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{gr2l}\;(\Varid{s},\Varid{sqs})\mathrel{=}\Varid{s}\mathbin{:}\Varid{concat}\;\Varid{sqs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{(\Conid{Square}}^*)^*
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{Square}}^*\ensuremath{\times(\Conid{Square}}^*)^*)
           \ar[l]_-{\ensuremath{\Varid{inList}}}
\\
     \ensuremath{\N_0}
           \ar[r]_-{\ensuremath{\Varid{genecarpets}}}
           \ar[u]^-{\ensuremath{\ana{\Varid{carpets}}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{Square}}^*\ensuremath{\times\N_0)}
           \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\ana{\Varid{carpets}}}}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{genecarpets}\mathbin{::}\Conid{Int}\to ()+([\mskip1.5mu \Conid{Square}\mskip1.5mu],\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{genecarpets}\;\mathrm{0}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{genecarpets}\;\Varid{x}\mathrel{=}i_2\;(\Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\Varid{x}\mathbin{-}\mathrm{1}),\Varid{x}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
...
Diagrama correspondente ao \ensuremath{\Varid{consolidate'}}:

\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{(\Conid{A}\times\mathit B)}^*
           \ar[d]_-{\ensuremath{\Varid{consolidate'}}}
           \ar[r]^-{\ensuremath{\Varid{outList}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}((\Conid{A}\times\mathit B)\times(\Conid{A}\times\mathit B)}^*)
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{consolidate'}}}
\\
     \ensuremath{(\Conid{A}\times\mathit B)}^*
&
     \ensuremath{\mathrm{1}\mathbin{+}((\Conid{A}\times\mathit B)\times(\Conid{A}\times\mathit B)}^*)
           \ar[l]^-{\ensuremath{\Varid{cgene}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cgeneaux}\mathbin{::}(\Conid{Eq}\;\Varid{a},\Conid{Num}\;\Varid{b})\Rightarrow (\Varid{a},\Varid{b}){}\<[37]%
\>[37]{}\to [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{cgeneaux}\;(\Varid{a},\Varid{b})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{cgeneaux}\;(\Varid{a},\Varid{b})\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t})\mid (\Varid{a}\equiv \Varid{x})\mathrel{=}((\Varid{x},\Varid{y}\mathbin{+}\Varid{b})\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
\>[26]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{x},\Varid{y})\mathbin{:}(\Varid{cgeneaux}\;(\Varid{a},\Varid{b})\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cgene}\;(i_2\;((\Varid{a},\Varid{b}),\Varid{l}))\mathrel{=}\Varid{cgeneaux}\;(\Varid{a},\Varid{b})\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{criapar}\mathbin{::}\Varid{a}\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{criapar}\;\Varid{e}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{criapar}\;\Varid{e}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}[\mskip1.5mu (\Varid{e},\Varid{x})\mskip1.5mu]\mathbin{+\!\!\!+}\Varid{criapar}\;\Varid{e}\;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{pairup}\;(\Varid{x}\mathbin{:}\Varid{t})\mathrel{=}\Varid{criapar}\;\Varid{x}\;\Varid{t}\mathbin{+\!\!\!+}\Varid{pairup}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{matchResult}\;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{case}\;\Varid{f}\;(\Varid{a},\Varid{b})\;\mathbf{of}{}\<[E]%
\\
\>[13]{}\hsindent{2}{}\<[15]%
\>[15]{}\Conid{Just}\;\Varid{x}\to \mathbf{if}\;\Varid{x}\equiv \Varid{a}\;\mathbf{then}\;[\mskip1.5mu (\Varid{a},\mathrm{3}),(\Varid{b},\mathrm{0})\mskip1.5mu]\;\mathbf{else}\;[\mskip1.5mu (\Varid{b},\mathrm{3}),(\Varid{a},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[13]{}\hsindent{2}{}\<[15]%
\>[15]{}\Conid{Nothing}\to [\mskip1.5mu (\Varid{a},\mathrm{1}),(\Varid{b},\mathrm{1})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Diagrama correspondente ao \ensuremath{\Varid{glt}}:

\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{{\LTree}\;\mathit B}
&
    \ensuremath{\mathit B\mathbin{+}{\LTree}\times{\LTree}}
           \ar[l]_-{\ensuremath{\mathsf{in}_{\tiny\ \textit{LTree}}}}
\\
     \ensuremath{\mathit B}^*
           \ar[r]_-{\ensuremath{\Varid{glt}}}
           \ar[u]^-{\ensuremath{\Varid{initKnockoutStage}}}
&
     \ensuremath{\mathit B\mathbin{+}\mathit B}^*\ensuremath{\times\mathit B}^*
           \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{initKnockoutStage}\times\Varid{initKnockoutStage}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{glt}\;\Varid{l}\mathrel{=}i_2\;(\Varid{take}\;\Varid{half}\;\Varid{l},\Varid{drop}\;\Varid{half}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{half}\mathrel{=}(\length \;\Varid{l})\mathbin{\Varid{`div`}}\mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{Versão probabilística}
\begin{hscode}\SaveRestoreHook
