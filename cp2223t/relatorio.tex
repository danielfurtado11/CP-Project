...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}\mathrel{=}(\Varid{id}+\Varid{id}\times(\Varid{auxiliar}\comp \map \;(\Varid{drop}\;\mathrm{4})))\comp \Varid{out}{}\<[E]%
\\
\>[B]{}\Varid{gene}\mathrel{=}\Varid{ola}\comp \Varid{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ola}\mathbin{::}\Conid{String}+(\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\to \Conid{String}+(\Conid{String},[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{ola}\;(i_1\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{ola}\;(i_2\;(\Varid{x},\Varid{ys}))\mathrel{=}i_2\;(\Varid{x},(\Varid{auxiliar}\;(\map \;(\Varid{drop}\;\mathrm{4})\;\Varid{ys}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxiliar}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxiliar}\mathrel{=}\Varid{myfoldr}\;\Varid{f}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\;\Varid{x}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{x}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{f}\;\Varid{x}\;(\Varid{y}\mathbin{:}\Varid{ys})\mathrel{=}\mathbf{if}\;\Varid{isPrefixOf}\;\text{\ttfamily \char34 ~\char34}\;\Varid{x}\;\mathbf{then}\;(\Varid{x}\mathbin{:}\Varid{y})\mathbin{:}\Varid{ys}\;\mathbf{else}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathbin{:}\Varid{y}\mathbin{:}\Varid{ys}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment post = undefined}{}\<[E]%
\\
\>[B]{}\Varid{post}\;\Varid{exp}\mathrel{=}\Varid{postHelper}\;\Varid{exp}\;[\mskip1.5mu [\mskip1.5mu \mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{postHelper}\;(\Conid{Var}\;\Varid{v})\;\Varid{caminhos}\mathrel{=}\map \;(\Varid{v}\mathbin{:})\;\Varid{caminhos}{}\<[E]%
\\
\>[B]{}\Varid{postHelper}\;(\Conid{Term}\;\anonymous \;\Varid{filhos})\;\Varid{caminhos}\mathrel{=}\Varid{myfoldr}\;(\lambda \Varid{f}\;\Varid{c}\to \Varid{postHelper}\;\Varid{f}\;\Varid{c})\;\Varid{caminhos}\;\Varid{filhos}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment post = undefined}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment post :: Exp String String -> [[String]]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment post exp = postaux exp [[]]}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment postaux :: Exp String String -> [[String]] -> [[String]]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment postaux (Var v) x = map (v:) x}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment postaux (Term _ v) x = foldr (\f c -> postaux f c) x v}{}\<[E]%
\\
\>[B]{}\Varid{tudo}\mathrel{=}\Varid{post}\comp \Varid{tax}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment gsq = undefined}{}\<[E]%
\\
\>[B]{}\Varid{gsq}\mathbin{::}(\Conid{Square},\Conid{Int})\to \Conid{Square}+[\mskip1.5mu (\Conid{Square},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gsq}\;(\Varid{s},\mathrm{0})\mathrel{=}i_1\;\Varid{s}{}\<[E]%
\\
\>[B]{}\Varid{gsq}\;\Varid{x}\mathrel{=}i_2\;(\Varid{squaress}\;\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rose2List}\mathrel{=}\llparenthesis\, \Varid{gr2l}\,\rrparenthesis_\textit{\tiny R}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gr2l}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  gr2l :: Either Square [[Square]] -> [Square]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  gr2l Left s = [s]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  gr2l Right ((x:xs):t) = }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{squaress}\mathbin{::}(\Conid{Square},\Conid{Int})\to [\mskip1.5mu (\Conid{Square},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{squaress}\;(((\Varid{x},\Varid{y}),\Varid{side}),\Varid{d})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{let}\;\Varid{new\char95 side}\mathrel{=}\Varid{side}\mathbin{/}\mathrm{3}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{new\char95 squares}\mathrel{=}[\mskip1.5mu (((\Varid{x}\mathbin{+}\Varid{i}\mathbin{*}\Varid{new\char95 side},\Varid{y}\mathbin{+}\Varid{j}\mathbin{*}\Varid{new\char95 side}),\Varid{new\char95 side}),\Varid{d}\mathbin{+}\mathrm{1})\mid \Varid{i}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{2}\mskip1.5mu],\Varid{j}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{2}\mskip1.5mu],\neg \;(\Varid{i}\equiv \mathrm{1}\mathrel{\wedge}\Varid{j}\equiv \mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{in}\;\Varid{new\char95 squares}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cgeneaux}\;(\Varid{a},\Varid{b})\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{a}\equiv \Varid{x})\;\mathbf{then}\;{}\<[44]%
\>[44]{}((\Varid{x},\Varid{y}\mathbin{+}\Varid{b})\mathbin{:}\Varid{t})\;\mathbf{else}\;(\Varid{x},\Varid{y})\mathbin{:}(\Varid{cgeneaux}\;(\Varid{a},\Varid{b})\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[13]{}\hsindent{2}{}\<[15]%
\>[15]{}\Conid{Just}\;\Varid{a}\to [\mskip1.5mu (\Varid{a},\mathrm{3})\mskip1.5mu]\mathbin{+\!\!\!+}[\mskip1.5mu (\Varid{b},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[13]{}\hsindent{2}{}\<[15]%
\>[15]{}\Conid{Just}\;\Varid{b}\to [\mskip1.5mu (\Varid{b},\mathrm{3})\mskip1.5mu]\mathbin{+\!\!\!+}[\mskip1.5mu (\Varid{a},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[13]{}\hsindent{2}{}\<[15]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  glt (x:xs) = (Right )}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment glt = undefined}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{Versão probabilística}
\begin{hscode}\SaveRestoreHook
